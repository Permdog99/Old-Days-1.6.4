...
public class ModelBiped extends ModelBase
{
	...
	bipedRightArm.rotateAngleX = MathHelper.cos(f * 0.6662F + 3.141593F) * 2.0F * f1;
	bipedLeftArm.rotateAngleX = MathHelper.cos(f * 0.6662F) * 2.0F * f1;
        ...
        if(isSneak)
        {
            ...
            bipedRightArm.rotateAngleX = MathHelper.cos(f * 0.6662F + 3.141593F) * 1.4F * f1 + 0.4F;
            bipedLeftArm.rotateAngleX = MathHelper.cos(f * 0.6662F) * 1.4F * f1 + 0.4F;
        } else
        {
