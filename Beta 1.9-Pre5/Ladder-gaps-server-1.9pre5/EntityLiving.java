...
public abstract class EntityLiving extends Entity
{
    ...
    public void func_40103_i(int i)
    {
        health = i;
        if(i > func_40095_c())
        {
    ...
    protected int func_40099_b(DamageSource damagesource, int i)
    {
        ...
        {
            int j = (func_35187_b(Potion.field_35459_m).func_35652_c() + 1) * 5;
            int k = 25 - j;
    ...
    protected void jump()
    {
        ...
        {
            motionY += (float)(func_35187_b(Potion.field_35460_j).func_35652_c() + 1) * 0.1F;
        }
        if(getSprinting())
        {
