...
public class BlockPistonBase extends Block
{
    ...
    public void playBlock(World world, int i, int j, int k, int l, int i1)
    {
        ...
        if(l == 1)
        {
            ...
            if(isSticky)
            {
                ...
                if(j2 > 0 && (flag || canPushBlock(j2, world, k1, l1, i2, false)) && (Block.blocksList[j2].getMobilityFlag() == 0 || j2 == Block.pistonBase.blockID || j2 == Block.pistonStickyBase.blockID))
                {
                    ignoreUpdates = false;
    ...
    private static boolean canExtend(World world, int i, int j, int k, int l)
    {
        ...
        do
        {
            ...
            if(j1 <= 0 || j1 >= world.field_35251_c - 1)
            {
                return false;
            }
