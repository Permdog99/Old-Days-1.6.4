...
public abstract class EntityLiving extends Entity
{
    ...
    public void onEntityUpdate()
    {
        ...
        if(isEntityAlive() && isInsideOfMaterial(Material.water) && !canBreatheUnderwater() && !field_35191_aF.containsKey(Integer.valueOf(Potion.field_35457_o.field_35447_H)))
        {
            air--;
            if(air == -20)
            {
        ...
        if(health <= 0)
        {
            ...
            if(deathTime > 20)
            {
                ...
                {
                    for(int j = func_36000_a(field_34903_b); j > 0;)
                    {
    ...
    protected int func_36000_a(EntityPlayer entityplayer)
    {
    ...
    {
        return field_35191_aF.containsKey(Integer.valueOf(potion.field_35447_H));
    }

    public PotionEffect func_35187_b(Potion potion)
    {
        return (PotionEffect)field_35191_aF.get(Integer.valueOf(potion.field_35447_H));
    }
